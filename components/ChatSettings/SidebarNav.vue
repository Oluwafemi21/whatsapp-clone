<template>
  <aside
    class="fixed h-[489px] w-[165px] flex flex-col justify-between bg-gray-100 dark:bg-neutral-800 dark:border-l-0 dark:border-y-0 border-x border-y dark:border-r-black/40 rounded-bl-md rounded-tl-md py-1 px-1"
  >
