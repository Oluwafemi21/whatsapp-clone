<template>
  <section class="flex flex-col gap-4 overflow-y-scroll h-full p-4 scroll-p-0">
    ...
    <div>
      ...
      <div class="flex items-center justify-between mt-3">
        ...
        <p class="text-sm text-neutral-600 dark:text-neutral-400">Nobody</p>
      </div>
      ...
      <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between">
          ...
          <p class="text-sm dark:text-neutral-400 text-neutral-600">Everyone</p>
        </div>
        <div class="flex items-center justify-between">
          <p class="text-sm dark:text-neutral-400 text-neutral-600">About</p>
          <p class="text-sm dark:text-neutral-400 text-neutral-600">
            My contacts
          </p>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <p class="text-sm dark:text-neutral-400 text-neutral-600">Off</p>
        </div>
      </div>
    ...
    <div class="border-t flex flex-col gap-1.5 border-neutral-600 pt-4">
      ...
      <p class="text-sm text-neutral-500">
        Messagess and calls in end-to-end encrypted chats stay between you and
        the people you choose. Not even Whatsapp can read or listen to them.
        <span class="text-emerald-500 underline cursor-pointer hover:text-white"
          >Learn More</span
        >
      </p>
      ...
      <p class="text-xs text-neutral-500">
        Get notified when your security code changes for a contact's phone. If
        you have multiple devices, this setting must be enabled on each device
        where you want to get notifications.
        <span class="text-emerald-500 underline cursor-pointer hover:text-white"
          >Learn More</span
        >
      </p>
