        ...
        <ul class="pt-1 flex flex-col gap-1 mb-3">
            <li v-for="tab in tabs" :key="tab.name" class="relative">
                <button
                    ...
                    class="w-full flex items-center gap-3 pl-3 h-9 hover:bg-neutral-700/40 focus:outline-none focus:bg-neutral-700/40 relative rounded"
...
<style scoped>
.active {
    @apply bg-neutral-700/40 before:block before:absolute before:h-4 before:w-[3px] before:bg-green-600 before:left-0 before:rounded;
}
</style>
